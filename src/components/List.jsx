...
const List = ({colection, keys}) => {
    return (
        colection.map((user, index) => (
            <div className="col-sm-3 text-center" key={index}>
                <div className="card mb-4">
                    <div className='w-100'>
                        <img src={user[keys[0]]} className="img-responsive rounded-circle text-center mt-3" alt="..." width="100" height="100" />
                    </div>
                    ...
                    <div className="card-footer">
                        <Link role="button" className="btn btn-dark btn-sm" to={'/users/' + user[keys[1]]}>
                            About
                        </Link>
                    </div>
                </div>
